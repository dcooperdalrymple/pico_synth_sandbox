# Modified slightly for more control over asynchronous playback
...
class MidiParser:
    ...
    def _parse_realtime_event(self, event_status):
    ...
    def _parse_message( self ):
        ...
        return self._parse_realtime_event(event_status)
...
class MidiPlay:
    ...
    """
    def __init__( self, midi_event_source, sleep=True ):
    ...
    def __next__( self ):
        ...
        if wait_time > 0 and self.sleep_enabled:
